  ...
  return (
    <>
      ...
      <div className="h-[100vh] p-8 flex justify-center items-center" data-theme="cyberpunk" >
        <div className="mockup-window border border-base-300 h-[80%] w-full" data-theme="aqua">
...
const TextToRecipe = ({ handleSignOut, signInWithGoogle }) => {
  ...
  return (
    <>
      ...
      {/*
      <div className="flex justify-center items-center h-[calc(100vh-66.5px)] px-10">

          <div className="mockup-window border bg-base-300 h-[80%] w-full">
            <div className="h-[100%] bg-slate-500">
              <div className="h-[90%] bg-red-400 px-4 py-4">
                {messages.map((message, index) => (
                  <ChatBubble start={index % 2 !== 0} text={message} key={index} />
                ))}
              </div>
...
*/}
      <div className="h-[calc(90vh-66.5px)] px-8 flex justify-center items-center pt-4" data-theme="cyberpunk" >
        <div className="mockup-window border border-base-300 h-[80%] w-full" data-theme="aqua">
          <div className="border-t border-base-300 flex-grow overflow-y-auto">
            <div className="flex flex-col h-full">
              <div className="flex-grow overflow-y-auto p-4">
